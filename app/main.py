...
# 予定編集ページを表示
@app.route('/schedule/<uuid:schedule_id>')
...
def create_schedule():
	...
	new_schedule = Schedule(title=title, startdate=startdate, category=category, location=location,url_link=url_link, content=content)#新たにカラム追加予定
